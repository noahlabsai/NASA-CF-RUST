...
pub type CF_CFDP_StateSendFunc_t = Option<unsafe fn(txn: *mut CF_Transaction_t)>;

/// A function for dispatching actions to a handler, with existing PDU data
pub type CF_CFDP_StateRecvFunc_t = Option<unsafe fn(txn: *mut CF_Transaction_t, ph: *mut CF_Logical_PduBuffer_t)>;
