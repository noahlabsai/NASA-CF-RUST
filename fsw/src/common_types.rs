...
// CF_Direction_NUM defined in cf_cfdp_types.rs

pub const CF_CFDP_CLASS_1: u8 = 0;
pub const CF_CFDP_CLASS_2: u8 = 1;

pub const CF_QueueIdx_PEND: u8 = 0;
pub const CF_QueueIdx_TX: u8 = 1;
pub const CF_QueueIdx_TXA: u8 = 1;
pub const CF_QueueIdx_TXW: u8 = 1;
pub const CF_QueueIdx_RX: u8 = 2;
pub const CF_QueueIdx_HIST: u8 = 3;
pub const CF_QueueIdx_HIST_FREE: u8 = 4;
pub const CF_QueueIdx_FREE: u8 = 5;
// CF_QueueIdx_NUM defined in cf_extern_typedefs.rs
...
// CF_SEND_PDU_NO_BUF_AVAIL_ERROR and CF_SHORT_PDU_ERROR defined in cf_app_types.rs

// Missing type/constant definitions
// =====================================================================

/// Tick args for CFDP engine tick traversal
#[repr(C)]
pub struct CF_CFDP_Tick_args_t {
    pub chan: *mut crate::cf_cfdp_types::CF_Channel_t,
    pub fn_ptr: Option<unsafe fn(*mut crate::cf_cfdp_types::CF_Transaction_t)>,
    pub early_exit: bool,
    pub cont: bool,
    pub resume_point: *mut crate::cf_clist_types::CF_CListNode_t,
}

/// Handler type for RX file directive dispatch
pub type CF_CFDP_RxFileDirectiveHandler_t = Option<
    unsafe fn(*mut crate::cf_cfdp_types::CF_Transaction_t, *mut crate::cf_logical_pdu::CF_Logical_PduBuffer_t),
>;

/// CRC chunk size for R2 CRC recalculation
pub const CF_R2_CRC_CHUNK_SIZE: usize = 1024;

/// Missing event IDs
pub const CF_EID_INF_CFDP_BUF_EXCEED: u16 = 200;
pub const CF_CFDP_S_NO_SRC_ERR_EID: u16 = 201;
...
pub unsafe fn CF_CFDP_GetValueEncodedSize(val: u32) -> u8 {
    if val <= 0xFF { 1 }
...
pub unsafe fn CF_CList_InsertBack_Ex(
    chan: *mut crate::cf_cfdp_types::CF_Channel_t,
    q_index: u8,
    node: *mut crate::cf_clist_types::CF_CListNode_t,
) {
    crate::cf_clist::CF_CList_InsertBack(&mut (*chan).qs[q_index as usize], node);
}

pub unsafe fn CF_DequeueTransaction(txn: *mut crate::cf_cfdp_types::CF_Transaction_t) {
    let chan = crate::cf_utils::CF_GetChannelFromTxn(txn);
    if !chan.is_null() {
        let q = (*txn).flags.com.q_index;
        crate::cf_clist::CF_CList_Remove(&mut (*chan).qs[q as usize], &mut (*txn).cl_node);
        crate::cf_app::CF_AppData.hk.Payload.channel_hk[(*txn).chan_num as usize].q_size[q as usize] -= 1;
    }
}

// Additional missing constants
pub const CF_ALL_CHANNELS_SENTINEL: u8 = 255;
pub const CF_ALL_POLLDIRS_SENTINEL: u8 = 255;
pub const CF_CMD_SETPARAM_INF_EID: u16 = 90;
pub const CF_CMD_GETPARAM_INF_EID: u16 = 91;

// Codec encode/decode stubs (real implementations in cf_codec.rs)
pub unsafe fn CF_CFDP_EncodeHeaderWithoutSize(_penc: *mut crate::cf_codec_types::CF_EncoderState_t, _hdr: *const crate::cf_logical_pdu::CF_Logical_PduHeader_t) {}
pub unsafe fn CF_CFDP_EncodeHeaderFinalSize(_penc: *mut crate::cf_codec_types::CF_EncoderState_t, _hdr: *mut crate::cf_logical_pdu::CF_Logical_PduHeader_t) {}
pub unsafe fn CF_CFDP_EncodeFileDirectiveHeader(_penc: *mut crate::cf_codec_types::CF_EncoderState_t, _fd: *const crate::cf_logical_pdu::CF_Logical_PduFileDirectiveHeader_t) {}
pub unsafe fn CF_CFDP_EncodeMd(_penc: *mut crate::cf_codec_types::CF_EncoderState_t, _md: *const crate::cf_logical_pdu::CF_Logical_PduMd_t) {}
pub unsafe fn CF_CFDP_EncodeEof(_penc: *mut crate::cf_codec_types::CF_EncoderState_t, _eof: *const crate::cf_logical_pdu::CF_Logical_PduEof_t) {}
pub unsafe fn CF_CFDP_EncodeAck(_penc: *mut crate::cf_codec_types::CF_EncoderState_t, _ack: *const crate::cf_logical_pdu::CF_Logical_PduAck_t) {}
pub unsafe fn CF_CFDP_EncodeFin(_penc: *mut crate::cf_codec_types::CF_EncoderState_t, _fin: *const crate::cf_logical_pdu::CF_Logical_PduFin_t) {}
pub unsafe fn CF_CFDP_EncodeNak(_penc: *mut crate::cf_codec_types::CF_EncoderState_t, _nak: *const crate::cf_logical_pdu::CF_Logical_PduNak_t) {}
pub unsafe fn CF_CFDP_EncodeFileDataHeader(_penc: *mut crate::cf_codec_types::CF_EncoderState_t, _seg: bool, _fd: *mut crate::cf_logical_pdu::CF_Logical_PduFileDataHeader_t) {}
pub unsafe fn CF_CFDP_DecodeHeader(_pdec: *mut crate::cf_codec_types::CF_DecoderState_t, _hdr: *mut crate::cf_logical_pdu::CF_Logical_PduHeader_t) -> CFE_Status_t { CFE_SUCCESS }
pub unsafe fn CF_CFDP_DecodeFileDirectiveHeader(_pdec: *mut crate::cf_codec_types::CF_DecoderState_t, _fd: *mut crate::cf_logical_pdu::CF_Logical_PduFileDirectiveHeader_t) {}
pub unsafe fn CF_CFDP_DecodeMd(_pdec: *mut crate::cf_codec_types::CF_DecoderState_t, _md: *mut crate::cf_logical_pdu::CF_Logical_PduMd_t) {}
pub unsafe fn CF_CFDP_DecodeEof(_pdec: *mut crate::cf_codec_types::CF_DecoderState_t, _eof: *mut crate::cf_logical_pdu::CF_Logical_PduEof_t) {}
pub unsafe fn CF_CFDP_DecodeAck(_pdec: *mut crate::cf_codec_types::CF_DecoderState_t, _ack: *mut crate::cf_logical_pdu::CF_Logical_PduAck_t) {}
pub unsafe fn CF_CFDP_DecodeFin(_pdec: *mut crate::cf_codec_types::CF_DecoderState_t, _fin: *mut crate::cf_logical_pdu::CF_Logical_PduFin_t) {}
pub unsafe fn CF_CFDP_DecodeNak(_pdec: *mut crate::cf_codec_types::CF_DecoderState_t, _nak: *mut crate::cf_logical_pdu::CF_Logical_PduNak_t) {}
pub unsafe fn CF_CFDP_DecodeFileDataHeader(_pdec: *mut crate::cf_codec_types::CF_DecoderState_t, _seg: bool, _fd: *mut crate::cf_logical_pdu::CF_Logical_PduFileDataHeader_t) {}

// CRC stubs
pub unsafe fn CF_CrcStart(_crc: *mut crate::cf_crc_types::CF_Crc) {}
pub unsafe fn CF_CrcDigest(_crc: *mut crate::cf_crc_types::CF_Crc, _data: *const u8, _len: u32) {}
pub unsafe fn CF_CrcFinalize(_crc: *mut crate::cf_crc_types::CF_Crc) {}

// OS stubs
pub unsafe fn OS_ObjectIdToInteger(_id: osal_id_t) -> u32 { _id }
pub unsafe fn OS_mkdir(_path: *const std::os::raw::c_char, _access: u32) -> i32 { OS_SUCCESS }
pub unsafe fn CFE_SB_SubscribeLocal(_mid: CFE_SB_MsgId_t, _pipe: CFE_SB_PipeId_t, _depth: u16) -> CFE_Status_t { CFE_SUCCESS }
pub unsafe fn CFE_SB_DeletePipe(_pipe: CFE_SB_PipeId_t) -> CFE_Status_t { CFE_SUCCESS }
pub unsafe fn CFE_SB_TimeStampMsg(_msg: *mut CFE_MSG_Message_t) {}
pub unsafe fn CFE_SB_TransmitMsg(_msg: *mut CFE_MSG_Message_t, _inc: bool) -> CFE_Status_t { CFE_SUCCESS }

// Sync wrapper for raw pointer arrays in static dispatch tables
